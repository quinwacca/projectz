...
const Aside = ({history, searchFocus}) => {
  ...
  return (
    <Fragment>
      <div className="navbar-tablet__logo" onClick={() => history.push('/')}>
      ...
      <div className="navbar-tablet__icons">
        <i className="fas fa-random" onClick={() => history.push('/random')} />
      </div>
      <div className="navbar-tablet__icons" onClick={() => history.push('/')}>
